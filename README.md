...
\(2^{33}\) and \(2^{35}\). Binius64 and ProveKit WHIR dash the standalone
commitment column (proof bytes are the transcript). Scheme names link to the
exact git commit that was measured.
