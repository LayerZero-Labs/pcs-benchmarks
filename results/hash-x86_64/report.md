...
Recorded runner command: `target/release/pcs-bench hash-eval run --scheme akita,akita-offload,akita-fp64,akita-fp64-offload,akita-fp128,akita-fp128-offload --payload 27,29,31,33,35 --threads 1,8 --runs 10 --warmups 1 --seed-mode vary --out results/hash-x86_64`. The commands below are a template,
